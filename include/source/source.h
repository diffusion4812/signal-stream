...
namespace signal_stream {
    ...
    struct Sample {
        ...
        uint64_t seq;
        uint32_t flags;
        Record instance; // Use Record to hold schema-based data
    };
    ...
    public:
        ...
        virtual bool TryAcquireSample(SampleHandle& outHandle, Record& instance) = 0;
    ...
    public:
        ...
        virtual bool TryAcquireSample(SampleHandle& outHandle, Record& instance) override {
    ...
    protected:
        ...
        virtual bool DoTryAcquireSample(SampleHandle&, Record&) = 0;
